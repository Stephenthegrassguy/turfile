// src/components/ControlBar/index.jsx
  ...
  const buttons = [
    {
      icon: (
        <img
          src={profileImageURL || "/default-user.png"}
          alt="Profile"
          style={styles.profileImage}
        />
      ),
      label: "Manage Account",
      onClickKey: "onShowAccountPanel",
    },
    {
      icon: <Plus size={20} color="#34d399" />,
      label: "Add Object",
      onClickKey: "onAddObject",
    },
    {
      icon: <LandPlot size={20} color="#3b82f6" />,
      label: "Manage Areas",
      onClickKey: "onManageAreas",
    },
    {
      icon: <List size={20} color="#fbbf24" />,
      label: "Head Inventory",
      onClickKey: "onShowInventoryPanel",
    },
    {
      icon: <TriangleAlert size={20} color="#ef4444" />,
      label: "Current Issues",
      onClickKey: "onShowIssuesPanel",
    },
    {
